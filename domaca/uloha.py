...
# dedičná trieda
class Ucitel(Osoba):  # dedičnosť – učiteľ zdedí všetky atribúty a metódy od triedy Osoba
    def __init__(self, meno, priezvisko, rok, titul, predmet, trieda=None):
        # trieda=None znamená, že atribút je nepovinný a defaultne bude None
